...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Alfian Malika — Frontend Web Developer</title>
        <meta name="description" content="Website resmi Alfian Malika, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan." />
     <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://alfianmalika.vercel.app" />
        <meta property="og:title" content="Alfian Malika — Frontend Web Developer" />
     <meta property="og:description" content="Website resmi dan portofolio Alfian Malika, Front-End Web Developer." />
        <meta property="og:url" content="https://alfianmalika.vercel.app" />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "url": "https://alfianmalika.vercel.app",
            "sameAs": [
              "https://github.com/Fiscalll2",
              "https://www.linkedin.com/in/alfian-malika-24b494327/"
            ]
          }
        `}</script>
      </Helmet>
              ...
              <div className="w-full py-0 md:py-[10%] sm:py-0 lg:w-1/2 h-[260px] sm:h-[400px] lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2  mt-5 sm:mt-0"
                ...
                <div className="relative w-full opacity-90">
                  ...
                  <div className={`relative lg:left-12 z-10 w-full opacity-90 transform transition-transform duration-500 ${
                    ...
                    {/* #GANTI: ganti Animation1.gif dengan animasi/gambar milikmu (taruh di public/) */}
                    <img
                      src="Animation1.gif"
